                        ...
                        <div class="tab-pane fade in active" id="register">
                            ...
                            <form form data-feedback='{"success": "fa-check", "error": "fa-times"}'>
                                <div class="col-lg-10 col-lg-offset-1 col-lg-offset-right-1 col-md-10 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">
                                    ...
                                    <input class="btn lt-register-btn " formaction="# " type="button" value="Stationery" onclick="window.location.href='http://localhost:81/App/www/stationery.php'" />

                                    </div>
                                    <div class="col-lg-10 col-lg-offset-1 col-lg-offset-right-1 col-md-10 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">

                                    <input class="btn lt-register-btn " formaction="# " type="button" value="Equipment" onclick="window.location.href='http://localhost:81/App/www/equipment.php'" />
                                    </div>
                                    <div class="col-lg-10 col-lg-offset-1 col-lg-offset-right-1 col-md-10 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">

                                    <input class="btn lt-register-btn " formaction="# " type="button" value="Support" onclick="window.location.href='http://localhost:81/App/www/support.php'" />
                                    </div>
                                    <div class="col-lg-10 col-lg-offset-1 col-lg-offset-right-1 col-md-10 col-md-offset-1 col-md-offset-right-1 col-sm-12 col-xs-12 pull-right ">

                                    <input class="btn lt-register-btn " formaction="# " type="button" value="Approvals" onclick="window.location.href='http://localhost:81/App/model/approvals.php'" />
