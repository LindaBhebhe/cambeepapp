                    ...
                    <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img class="img-responsive center-block" src="img/step3.png" alt="step1">
            ...
            <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                <div class="mlt-content">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#register" data-toggle="tab">Request status </a></li>
                        
                    </ul>
                    <div id="myTabContent" class="tab-content">
                        <div  style="background-color:pale blue;" class="tab-pane fade in active" id="login">
                          
                            <?php
                         Require('../model/supportFunctions.php');
                         getUserStationeryStatus();
